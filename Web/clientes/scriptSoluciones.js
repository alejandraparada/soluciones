      ...
      function loadTable(){
        ...
        myFeatureTable.on("load", function(evt){
          ...
          buttonTable.addEventListener("click", (evt) => {
            ...
            if(tableOption == 0){
              ...
              document.getElementById("formDespliegues").style.display="none";
              document.getElementById("formRecursos").style.display="none";
              document.getElementById("formSoluciones").style.display="none";
              document.getElementById("formWebmaps").style.display="none";
            }
            if(tableOption == 1){
              document.getElementById("formClientes").style.display="none";
              document.getElementById("formDespliegues").style.display="block";
              document.getElementById("formRecursos").style.display="none";
              document.getElementById("formSoluciones").style.display="none";
              document.getElementById("formWebmaps").style.display="none";
            }
            ...
            if(tableOption == 3){
              ...
              document.getElementById("formDespliegues").style.display="none";
              document.getElementById("formRecursos").style.display="none";
              document.getElementById("formSoluciones").style.display="block";
              document.getElementById("formWebmaps").style.display="none";
            }
            if(tableOption == 4){
              document.getElementById("formClientes").style.display="none";
              ...
              document.getElementById("formRecursos").style.display="none";
              document.getElementById("formSoluciones").style.display="none";
              document.getElementById("formWebmaps").style.display="block";
            }
          });
          ...
          buttonClearRecursos.addEventListener("click", (evt) => {
            myFeatureTable2.featureLayer.fields.forEach(field => {
              document.getElementById(`Recursos_${field.name}`).value = ''
            });
          });
          ...
          buttonClearSoluciones.addEventListener("click", (evt) => {
            myFeatureTable3.featureLayer.fields.forEach(field => {
              document.getElementById(`Soluciones_${field.name}`).value = ''
            });
          });
          ...
          buttonClearWebmaps.addEventListener("click", (evt) => {
            myFeatureTable4.featureLayer.fields.forEach(field => {
              document.getElementById(`Webmaps_${field.name}`).value = ''
            });
          });
        ...
        myFeatureTable.on("row-select", function(evt){
          myFeatureTable.featureLayer.fields.forEach(field => {
            ...
            for(let i = 0; i < Object.keys(data).length; i++){
              if(Object.keys(data)[i].endsWith(field.name)){
        ...
        myFeatureTable4.on("row-select", function(evt){
          myFeatureTable4.featureLayer.fields.forEach(field => {
            ...
            for(let i = 0; i < Object.keys(data).length; i++){
              if(Object.keys(data)[i].endsWith(field.name)){
                document.getElementById(`Webmaps_${field.name}`).value = Object.values(data)[i]
              }
            }
          });
        }); 
